...
<%@ page session="false" %>		
                 ...
                 <div class="control-group">
                        <label class="required"><s:message code="module.payment.paypal.clientId" text="Razorpay Key"/></label>
	                        <div class="controls">
                   ...
                   <div class="control-group">
                        <label class="required"><s:message code="module.payment.paypal.secret" text="Razorpay Value"/></label>
	                        <div class="controls">
