...
public class RazorPayPayment implements PaymentModule {
	...
	private Transaction processTransaction(MerchantStore store, Customer customer, TransactionType type,
		 ...
		 *  -----------
			...
			Prior to processing a pre-authorization through the API, you must modify the transaction settings in your Razorpay merchant member area to allow for this transaction type.
	...
	public void validateModuleConfiguration(
		...
		//TODO Hemant : Add integration keys requirement on to Razorpay.jsp. and then admin will add this to make payments.app
